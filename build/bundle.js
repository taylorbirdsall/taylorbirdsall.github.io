...
var Header = function () {
  ...
  _createClass(Header, [{
    ...
    value: function setUpSmoothScroll() {
      ...
      try {
        for (var _iterator = this.menuLinks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var menuLink = _step.value;

          menuLink.addEventListener('click', function () {
            var targetSection = (0, _jquery2.default)(this.hash);
            var topOffset = targetSection.offset().top - that.headerHeight;
